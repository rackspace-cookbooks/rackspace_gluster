...
default['yum']['glusterfs-epel']['baseurl'] = "http://download.gluster.org/pub/gluster/glusterfs/LATEST/EPEL.repo/epel-#{node[:platform_version]}/#{node[:kernel][:machine]}/"
...
default['yum']['glusterfs-noarch-epel']['baseurl'] = "http://download.gluster.org/pub/gluster/glusterfs/LATEST/EPEL.repo/epel-#{node[:platform_version]}/noarch"
...
default['yum']['epglusterfs-source-epelel']['baseurl'] = "http://download.gluster.org/pub/gluster/glusterfs/LATEST/EPEL.repo/epel-#{node[:platform_version]}/SRPMS"
